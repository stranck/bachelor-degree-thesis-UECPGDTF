...
\begin{itemize}
    ...
    \item $timeToFullyAccelerate$ (\say{TTFA}): È il tempo richiesto per raggiungere maxSpeed a partire da fermi e viceversa. Per ottenere quanto tempo ci mettiamo a raggiungere velocità massima o minima a partire da una velocita intermediaria, basta moltiplicare tale velocità per TTFA, poiché tutti i nostri calcoli sono nel range [0, 1].
...
\noindent Più specificatamente, abbiamo 3 casi da gestire (Visualizzati anche nella fiugra \ref{fig:4_speedCapThreeCases}):
\begin{enumerate}
