...
Il codice per la generazione del codice HLSL in sé è molto semplice. Si prende in input un array di ShaperFixtureComponent già istanziati e per ciascuno controlla se sono in modalità A+B oppure A+Rot, e seleziona la relativa chiamata a funzione corretta.
\begin{lstlisting}
