...
%TODO wrap figure componente iris di una luce
...
Le seguenti immagini mostrano il risultato della generazione \say{finale} della pipeline di rendering, sia all'interno della MaterialFunction per quanto riguarda Light e Lens e sia all'interno del materiale Beam.
\begin{figure}[H]
    \centering
...
\end{lstlisting}
%TODO Check if the previous code fits in just one window
\begin{figure}[H]
    \centering
