...
\begin{itemize}
    ...
    \item \textbf{MaterialExpressionCustom}: Tipo di MaterialExpression che prende degli input e ritorna degli output. Mentre una MaterialExpressionFunctionCall elabora gli output utilizzando una MaterialFunction (E quindi un grafo), una MaterialExpressionCustom esegue codice vero e proprio scritto in HLSL, un linguaggio C-like utilizzato per la scrittura di Shader
\end{itemize}
